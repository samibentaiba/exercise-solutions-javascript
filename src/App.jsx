...
/* // WarmUp exercise: functions and components as jsx
import ZeroTwo from "./assets/ZeroTwo.jpg";
function Card() {
  return (
    <>
...
export default function App() {
  ...
  */
/* // WarmUp exercise: files and components as jsx 
 ...
 */
// WarmUp exercise: object mapping in jsx
 ...
 */
/* // WarmUp exercise: objects in arrays in jsx
function People() {
  const people = [
